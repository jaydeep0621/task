...
const { findAllStudents, findStudentDetail, findStudentToSetStatus, addOrUpdateStudent, deleteStudent: deleteStudentRepo } = require("./students-repository");
...
const deleteStudent = async (id) => {
    await checkStudentId(id);
    const affectedRows = await deleteStudentRepo(id);
    if (affectedRows <= 0) {
